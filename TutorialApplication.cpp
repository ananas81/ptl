...
void TutorialApplication::initPhysics()
{
	...
	flywheelBody1->setDamping(0.0001f,0.0001f);
	...
	btTypedConstraint* p2p = new btPoint2PointConstraint(*flywheelBody1, *ropeSphereBody, btVector3(0,-38.5,0), btVector3(0,6.12,0));
