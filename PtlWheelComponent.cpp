				       ...
				       mWheelHinge(NULL)
{
	...
	//rackBody->setLinearFactor(btVector3(0, 0, 0.5));
	...
	rackBottom.setOrigin(btVector3(0., -170.0, 0.));
	...
	dofConstr->getTranslationalLimitMotor()->m_enableMotor[0] = true;
	dofConstr->setLinearUpperLimit(btVector3(10.0, 0.0, 0.0));
	dofConstr->setLinearLowerLimit(btVector3(-10.0, 0.0, 0.0));
	dofConstr->setAngularUpperLimit(btVector3(0.0, 0.0, 0.0));
	dofConstr->setAngularLowerLimit(btVector3(0.0, 0.0, 0.0));
        for (int i = 0; i < 3; ++i)
	{
